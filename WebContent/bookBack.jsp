...
<%@ page import="cn.jju.library.entity.ReaderForm"%>
	...
	<section>
		...
		<div style="height: 400px; padding-left: 5px;">
			<table width="95%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="738" height="33" background="Images/bookgh.gif">&nbsp;</td>
				</tr>
				<tr>
					<td height="72" align="center" valign="top"
						background="Images/main_booksort_1.gif" bgcolor="#F8BF73"><table
												...
												<td><table width="90%" height="21" border="0"
														...
														<tr>
															...
															<td width="76%" style="padding-top: 7px;">读者条形码： <input
																...
																name="Button" type="button" value="确定"
							...
							<tr>
								<td valign="top"><table width="100%" height="35" border="1"
										...
										<tr align="center" bgcolor="#e3F4F7">
											...
											<td width="12%" bgcolor="#FFF9D9"><input name="Button22"
												type="button" value="完成归还"
